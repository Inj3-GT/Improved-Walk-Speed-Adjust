...
if (SERVER) then
    ...
    ipr_SpeedWheel_Config.ReduceSlowWalkSpeed = 0.75 --- Réduit 50% de la vitesse maximale de marche lente (mettre 1 si vous ne voulez pas de réduction de la vitesse de marche lente). | Withdraws 50% of max slow walk speed (set 1 if you don't want a slow walk reduction).
